...
const NavigationBar = () => {
	...
	return <>
		<nav className='w-full mx-1 lg:hidden p-2 bg-white sticky bottom-0 flex items-center justify-center z-10'>
			...
			<Link href={'/usefull-websites'} ><img src='/websites.svg' alt='website' className={router.pathname == '/usefull-websites' ? `mx-3 w-8 border-4 border-black rounded-lg` : 'mx-3 w-8'} /></Link>
			...
			<Link href={'/about'} ><img src='/about.svg' alt='about' className={router.pathname == '/about' ? `mx-4 w-8 border-2 border-black rounded-lg` : 'mx-3 w-8'} /></Link>
		</nav>
	</>
}
